	...
	function userInsert(){
		...
		$('#btnInsert').on('click',function(){
			$.ajax({ 
			    ...
			    type: 'POST',  
			    dataType: 'json', 
//			    data : $("#form1").serialize(),		//@RequestBody를 빼고 사용하려면 (아래 두 줄 대신)
			    data : JSON.stringify($("#form1").serializeObject()), //serializeObject 타입(json)을 string 타입으로 변환
			    contentType: 'application/json',	//위 변환 방식 사용하려면 contentType(json이라고 명시) 중요 (JSON 구조 parsing을 위해서 controller에 @RequestBody 포함되어야 함)
